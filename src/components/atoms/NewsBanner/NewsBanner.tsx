...
const NewsBanner: React.FC = () => {
  ...
  const [showBanner, setShowBanner] = useState<boolean | string>(false);
  ...
  return (
    <section className="fixed top-0 left-0 w-full bg-red-500 text-white text-sm md:text-base z-[60] flex items-center justify-center px-6 py-4 shadow-md">
      <article className="flex flex-col md:flex-row items-center gap-4 text-center">
