...
export const VideoAboutCompany = () => {
  ...
  return (
    <section className="relative mt-8">
      {!showVideo ? (
        <article className="max-sm:h-[400px] max-lg:h-[600px] lg:h-[600px]  max-xl:h-[1000px] xl:h-[1000px] bg-[url('/images/main_page/video_bg.webp')] bg-cover bg-center flex justify-center items-center">
          <Button
        ...
        <article className="max-w-[1920px] max-sm:h-[400px] max-lg:h-[600px] lg:h-[600px] max-xl-h-[1000px] xl:h-[1000px] mx-2 md:mx-0">
          <ReactPlayer
